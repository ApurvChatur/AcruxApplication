          ...
          <div class="lg:w-4/6 mx-auto">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-[#603F83] dark:bg-[#C7D3D4] text-[#C7D3D4] dark:text-[#603F83]">
              ...
              <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-[#603F83] dark:border-[#C7D3D4] sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
        ...
        <div class="container px-5 py-12 mx-auto">
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#603F83] dark:border-[#C7D3D4] flex flex-col relative overflow-hidden">
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#603F83] dark:border-[#C7D3D4] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#603F83] dark:border-[#C7D3D4] leading-none">Basic Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#603F83] dark:border-[#C7D3D4] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#603F83] dark:border-[#C7D3D4] leading-none">Relation Information</h1>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border border-[#603F83] dark:border-[#C7D3D4] flex flex-col relative overflow-hidden">
                <h1 class="text-2xl pb-4 mb-4 border-b border-[#603F83] dark:border-[#C7D3D4] leading-none">More Information</h1>
